          ...
          return (
            <RevealItem key={item.title} className="h-full" distance={24}>
              <Link
                ...
                className="group flex h-full flex-col rounded-2xl border border-white/10 bg-[rgba(255,255,255,0.04)] p-8 backdrop-blur-sm transition-all duration-400 hover:-translate-y-1.5 hover:border-primary/60 hover:bg-[rgba(255,255,255,0.07)]"
              >
