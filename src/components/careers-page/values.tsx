      ...
      >
        {valuesData.features.map((value) => (
          <RevealItem key={value} className="h-full" distance={22}>
            <div className="glow-card glow-light sheen sheen-light relative isolate overflow-hidden flex h-full items-center gap-4 rounded-2xl border border-[#E4E4E8] bg-[#F6F6F7] p-6 transition-all duration-400 hover:-translate-y-1 hover:border-primary/40 hover:bg-white hover:shadow-[0_22px_50px_-24px_rgba(11,11,18,0.35)]">
